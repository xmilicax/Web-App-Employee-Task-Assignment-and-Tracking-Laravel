...
@section('title')
    <title>Rukovodilac odeljenja - Izmena zadatka</title>
@endsection
...
@section('content')
    <form action="{{ route('update_task_action_mng') }}" method="POST" class="form-group" enctype="multipart/form-data">
        @csrf
        ...
        <button type="submit" class="button">Kreiraj zadatak</button>
    </form>
@endsection
