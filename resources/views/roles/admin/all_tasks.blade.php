...
@section('title')
    ...
    <title>Admin - Spisak zadataka</title>
@endsection
    ...
    <div>
        <table>
            ...
            @foreach($tasks as $task)
                <tr>
                    <td>
                        <a href="{{ route('task_details_admin', $task) }}">{{ $task->title }}</a>
                    </td>
                    ...
                    <td>{{ $task->status }}</td>
                    <td><a href="{{ route('task_details_admin', $task) }}">Prikaži komentare</a></td>
                    <td>
                        <form action="{{ route('complete_manager_mng', $task) }}" method="POST" class="clear">
                            @csrf
                            <button type="submit" class="button" id="done">Završeno</button>
                        </form>
